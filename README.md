...
- **Libft** — building a personal C library from scratch
- **get_next_line** — reading files line by line using file descriptors and dynamic memory
- **ft_printf** — recreating core functionality of the C `printf` function
- **push_swap** — algorithmic sorting with a restricted set of stack operations
